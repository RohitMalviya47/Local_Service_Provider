...
const SearchBar = ({ onSearch }) => {
  ...
  return (
    <div className="relative w-full max-w-4xl mx-auto my-16 px-4 sm:px-6 lg:px-8">
      {/* Container with 2 sections: Location & Search */}
      <div className="flex flex-col sm:flex-row items-center gap-4 w-full">

        {/* 🔹 Location Selector */}
        <div className="flex items-center bg-gray-200 px-4 py-3 rounded-full text-gray-800 cursor-pointer font-medium w-full sm:w-auto border-2 border-gray-300">
        ...
        {/* 🔹 Search Bar */}
        <div className="flex items-center bg-white shadow-lg rounded-full p-3 sm:p-4 w-full border-2 border-gray-300">
          <input
            type="text"
            value={query}
